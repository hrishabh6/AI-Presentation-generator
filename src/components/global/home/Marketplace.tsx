            ...
            <div className="relative mt-10 lg:mt-0">
              ...
              <div className="relative bg-gray-950 border border-gray-800 rounded-3xl overflow-hidden shadow-2xl">
                ...
                <div className="grid grid-cols-2 gap-3 md:gap-4 p-4 md:p-6">
                  {[1, 2, 3, 4].map((i) => (
                    <div key={i} className="bg-gray-900 rounded-xl overflow-hidden group cursor-pointer">
                      <div className="aspect-video bg-gray-800 relative">
                        <img
                          src={`/placeholder.svg?height=200&width=300&text=Template ${i}`}
                          alt={`Template ${i}`}
                      ...
                      <div className="p-2 md:p-3">
                        <h4 className="font-medium text-xs md:text-sm mb-1">Business Template {i}</h4>
                        <div className="flex items-center justify-between">
                          <span className="text-xs text-gray-400">by Designer {i}</span>
